	...
	<div class="search-container">
		...
		<div class="options-section">
			<div class="option-row">
				<input type="text" id="includeInput" placeholder="包含的文件(./src, *ts, src/**/exclude)" spellcheck="false">
			</div>
			<div class="option-row">
				<input type="text" id="excludeInput" placeholder="排除的文件(./src, *ts, src/**/exclude)" spellcheck="false">
			</div>
